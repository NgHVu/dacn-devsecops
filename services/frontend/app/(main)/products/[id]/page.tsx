          ...
          <div className="space-y-4">
            {sortedReviews.length === 0 ? (
              ...
              sortedReviews.map((review) => {
                ...
                // --- LOGIC XỬ LÝ THỜI GIAN ĐÁNH GIÁ (FIXED) ---
                // Ưu tiên hiển thị updatedAt nếu có và khác createdAt
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 text-xs text-muted-foreground mt-0.5">
                            ...
                            <span>• {(displayDate ? new Date(displayDate).toLocaleString("vi-VN", { hour: "2-digit", minute: "2-digit", day: "2-digit", month: "2-digit", year: "numeric" }) : "")}</span>
                            {/* Hiển thị nhãn đã sửa nếu cần */}
                            {isEdited && <span className="italic text-[10px] ml-0.5">(Đã sửa)</span>}
                          </div>
